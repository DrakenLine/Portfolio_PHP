...
<!-- VAGUE -->
	...
	<h1 class="create-work-titre1">Ajouter un projet 🖌 :</h1>

	<form method="post" action="create_work.php">

<div class="bloc-edit-desc">

		<label class="edit-desc-titre2" for="newtitre">Titre :</label><br>
		<textarea class="form-control" style="width: 80%; height: 50px;" type="text" id="titre" name="titre" placeholder="Titre" autofocus=""></textarea> <br><br>

		<label class="edit-desc-titre2" for="newdescription">Description :</label><br>
		<textarea class="form-control" style="width: 80%; height: 200px;" type="text" name="description" id="description" placeholder="Description"></textarea> <br><br>
